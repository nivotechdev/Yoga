  ...
  const teachers = [
    {
      ...
      specialties: ["Hatha Yoga", "Breathwork Integrativo", "Meditação"],
    ...
    },
    {
      ...
      specialties: ["Vinyasa Flow", "Terapias Vibracionais", "Crescimento Pessoal"],
              ...
              >
                ...
                <div className="space-y-8">
                  ...
                  <div className="pt-8 border-t border-primary/10">
                    <h4 className="font-headline text-xl text-foreground mb-4 italic">Especialidades</h4>
                    <ul className="grid grid-cols-2 gap-4">
                      {teacher.specialties.map(spec => (
                        <li key={spec} className="flex items-center gap-3 text-sm text-muted-foreground font-medium">
